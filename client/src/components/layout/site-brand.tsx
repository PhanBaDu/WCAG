...
export function SiteBrand({ href = '/', className, tone = 'solid' }: SiteBrandProps) {
  ...
  return (
    <Link
      href={href}
      className={cn(
        'group inline-flex w-fit items-center gap-3 rounded-none px-0 py-0 font-bold uppercase tracking-tight transition-[color,text-decoration-thickness,background-color] duration-150',
        isInverse
